...
const TradeAssurance = () => {
  ...
  const coverageAmounts = [
    ...
    { level: "Premium", amount: "₹2,00,000", color: "bg-green-100 text-green-800" },
    { level: "Gold", amount: "₹5,00,000", color: "bg-yellow-100 text-yellow-800" },
    { level: "Platinum", amount: "₹10,00,000", color: "bg-purple-100 text-purple-800" }
  ];
